...
namespace MiniORMImplementation
{
    public abstract class DbContext
    {
        ...
        protected DbContext(string coonectionString)
        {
            this.connection = new DatabaseConnection(coonectionString);
            ...
            where TEntity : class, new()
        {
            ...
            foreach (var foreignKey in foreignKeys)
            {
                ...
                foreach (var entity in dbSet)
                {
                    ...
                    var navigationPrototypeValue = ((IEnumerable<object>)navigationDbSet).First(currentNavigationProperty =>
                     navigationPrimaryKey.GetValue(currentNavigationProperty).Equals(foreignKeys));

                    navigationProperty.SetValue(entity, navigationPropertyName);
                }
            }
        }
